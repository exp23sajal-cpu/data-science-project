...
with open('county_murders_octave.m', 'w') as f:
    f.write(octave_code)

print("✓ Octave/MATLAB Code Created Successfully!")
print("✓ File: county_murders_octave.m")
print("\nThis script includes:")
print("  - Data loading and preprocessing")
print("  - Descriptive statistics")
print("  - Correlation analysis")
print("  - 6 different visualizations")
